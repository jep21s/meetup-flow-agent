...
ДЗ6 требует: 2–3 метрики (успех/время/стоимость); логирование выполнения; одно
ограничение (лимит итераций или retry); проверка ответа или защита от ошибки.
Формат сдачи — код + фрагмент лога выполнения.
...
## Логирование выполнения (стиль памятки курса, §14)
...
Фрагмент реального лога happy-флоу (шаги 1–6, живой прогон 2026-09-14):
